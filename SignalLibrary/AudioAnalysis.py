...
class AudioAnalysis:
    ...
    # def loop_gravity(self, data, env, atkThresh, relThresh, numLoops, gConst=1, rPow=2, panRatio=2, panThresh=50, magnitudeScale='RMS', mos='S', graph=True):
    #     print("Loop 1")
    #     rCon = Reconstruct()
    #     self.audio_events = []
    #     self.calc_shift(data, env, atkThresh, relThresh, gConst, rPow, panRatio, panThresh, magnitudeScale, retOption="N", applyShift="Y")
    #     rM = rCon.reconstruct_mono(len(data), self.audio_events)
    #     if rCon.bounds_reached == True:
    #         print("Padding")
    #         rM = rCon.depad_mono(rM, 200)
    #     self.audio_events = []
    #     if graph:
    #         plt.plot(rM, 'r')
    #         plt.show()
    ...
    #             rM = rCon.reconstruct_mono(len(rM), self.audio_events)
    #             if rCon.bounds_reached == True:
    #                 print("Padding")
    #                 rM = rCon.depad_mono(rM, 200)
    #             if graph:
    ...
    #     env = self.get_env_pd(rM)
    #     self.calc_shift(rM, env, atkThresh, relThresh, gConst, rPow, panRatio, panThresh, magnitudeScale, retOption="N", applyShift="Y")
    #     rS = rCon.reconstruct_stereo(len(rM), self.audio_events)
    #     if rCon.bounds_reached == True:
    #         print("Padding")
    #         rS = rCon.depad_stereo(rS, 200)
    #     if graph:
    #         plt.plot(rS, 'r')
    #         plt.show()
    #     return rS
