...
a = SinWave(440, 0.01).make_wave()
b = SinWave(440, 0.02).make_wave()
c = SinWave(440, 0.03).make_wave()
sf.write("Sin1m.wav", a.data, 44100)
sf.write("Sin2m.wav", b.data, 44100)
sf.write("Sin3m.wav", c.data, 44100)
